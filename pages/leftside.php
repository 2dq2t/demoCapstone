<div class="collapse navbar-collapse navbar-ex1-collapse">
				<ul class="nav navbar-nav side-nav">
					<li ><a href="#"><i
							...
							<li><a href="addProductToSaless.php"><i class="fa fa-fw fa-edit"></i>Add Product to Sale</a></li>
							</ul>
							</li>
							<li><a href="javascript:;" data-toggle="collapse" data-target="#supplier"><i
							class="fa fa-fw fa-table"></i> Supplier<i class="fa fa-fw fa-caret-down"></i></a>
							<ul id="supplier" class="collapse">
							<li><a href="supplierInfo.php"><i class="fa fa-fw fa-table"></i>Supplier Info</a></li>
							...
							<li><a href="productInfo.php"><i class="fa fa-fw fa-table"></i>Product Info</a></li>
					...
					<li><a href="javascript:;" data-toggle="collapse" data-target="#statistic"><i
							...
							<li><a href="pieChart.php"><i class="fa fa-fw fa-bar-chart-o"></i>Pie Chart</a></li>
							<li><a href="lineChart.php"><i class="fa fa-fw fa-bar-chart-o"></i>Line Chart</a></li>
							</ul>
							</li>
				</ul>
			</div>
